	...
	questions_ =
{
    // region 1
    {
        ...
        {
            {"新しい経験", 1, 415, 760, 0, LoadGraph("Data/Image/Choice/新しい経験.png")},
    ...
    // region 2 - 安心感を選んだ場合
    {
        ...
        {
            {"呼べる",   3, 450, 760, 0, LoadGraph("Data/Image/Choice/呼べる.png")},
    ...
    // region 3
    {
        ...
        {
            {"押せる",   4, 450, 760, 0, LoadGraph("Data/Image/Choice/押せる.png")},
    ...
    // region 4 - 押せる
    {
        ...
        {
            {"語れる",   6, 450, 760, 0, LoadGraph("Data/Image/Choice/語れる.png")},
    ...
    // region 5
    {
        ...
        {
            {"完璧な計画", 7, 415, 760, 0, LoadGraph("Data/Image/Choice/完璧な計画.png")},
    ...
    // region 6 - 完璧な計画
    {
        ...
        {
            {"見なす",     9, 450, 760, 0, LoadGraph("Data/Image/Choice/見なす.png")},
    ...
    // region 8 - 探す
    {
        ...
        {
            {"言える",   12, 450, 760, 0, LoadGraph("Data/Image/Choice/言える.png")},
    ...
    // region 9
    {
        ...
        "それとも、おとなしく受け入れる？",
        {
            {"抗う",       13, 480, 760, 0, LoadGraph("Data/Image/Choice/優先しない.png")},
            {"受け入れる", 14, 1265, 760, 0, LoadGraph("Data/Image/Choice/優先しない.png")}
        }
    },
    ...
    // region 10 - 抗う
    {
        ...
        "その行動は正しかったと言える？",
        {
            {"言える",   -1, 450, 760, 0, LoadGraph("Data/Image/Choice/優先しない.png")},
            {"言えない", -1, 1290, 760, 0, LoadGraph("Data/Image/Choice/優先しない.png")}
        }
    },
...
#pragma region 7
	...
	{{"決断のエネルギーを他者に委ねる、ある意味で合理的な判断だね。",
		"その強制された目標を完璧に達成し、周囲が君の幸せを保証した場合、\n"
		"君はそこに「自己の選択」を見出すだろうか？"},9, 1},
...
#pragma region 8
	...
	{{"そっか。見出さないもしくは見出せないってところかな？",
		"他者からの評価や達成度に関わらず、「自らの意志」がなければ、\n"
		"それは偽りの人生ということだね。"}, 11, 1},
#pragma region 9
		// 抗うを選んだ場合
	{{"運命に屈しない、強い意志だね。\n"
	    "生きることに、徹底的に執着するか...",
